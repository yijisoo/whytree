...
**나에게 진짜 중요한 게 뭔지 알아가는 20분 AI 대화.**

뭔가 좀 안 맞는 느낌. 하루하루는 흘러가는데 내가 왜 이걸 하고 있는지 잘 모르겠는 느낌. 뭔가가 바뀌고 있어서 다음 걸 정하기 전에 내가 뭘 원하는지 먼저 알고 싶은 느낌. 다 잘해왔는데도 어딘가 허전한 느낌. 그냥 궁금한 것도 좋습니다.

다 맞는 이유입니다.

## 어떻게 진행되나요

AI 상담사와 대화합니다. 요즘 무슨 생각을 하고 있는지 물어보고, 듣고, 거기서부터 따라갑니다. "목표가 뭐예요?" 같은 질문은 하지 않습니다. 준비된 답이 나오니까요. 대신, 내가 하는 것들이 *왜* 중요한지를 추적해서 스스로 보지 못했던 것을 드러냅니다. 그다음, 같은 뿌리를 채울 수 있는 *다른 방법*을 물어서 생각지 못했던 길을 찾아줍니다.
...
모든 내용은 내 기기에만 저장됩니다. 내 말, 내 발견, 내 트리 — 어디에도 전송되지 않습니다.
